...
async function generarPDF() {{
    ...
    // 1. Reducir el ancho del container para que entre en A4 portrait (~190mm útiles)
    //    A4 = 210mm = ~794px @ 96dpi; con margen 10mm/lado quedan 190mm = ~720px.
    //    Trabajamos a 760px para tener un poquito de aire y que las grids respiren.
    ...
    // 2. Mostrar TODAS las main-tab-content y tab-content (para que Chart.js renderice)
    ...
    // 4. Re-render charts (ahora que sus parents son visibles y con nuevo ancho)
    if (typeof recomputeKPIsAndCharts === 'function') recomputeKPIsAndCharts();
